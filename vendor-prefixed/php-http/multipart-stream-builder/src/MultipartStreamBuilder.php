...
use YardDeepl\Vendor_Prefixed\Http\Discovery\StreamFactoryDiscovery;
...
class MultipartStreamBuilder
{
     ...
     *
     * @param string|resource|\YardDeepl\Vendor_Prefixed\Psr\Http\Message\StreamInterface $resource the filepath, resource or StreamInterface of the data
