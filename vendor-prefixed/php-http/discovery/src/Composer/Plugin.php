...
namespace YardDeepl\Vendor_Prefixed\Http\Discovery\Composer;
...
use YardDeepl\Vendor_Prefixed\Http\Discovery\ClassDiscovery;
...
class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    private const INTERFACE_MAP = [
        ...
        'psr/http-client-implementation' => [
            'YardDeepl\Vendor_Prefixed\Psr\Http\Client\ClientInterface',
        ],
        'psr/http-factory-implementation' => [
            'YardDeepl\Vendor_Prefixed\Psr\Http\Message\RequestFactoryInterface',
            'YardDeepl\Vendor_Prefixed\Psr\Http\Message\ResponseFactoryInterface',
            'YardDeepl\Vendor_Prefixed\Psr\Http\Message\ServerRequestFactoryInterface',
            'YardDeepl\Vendor_Prefixed\Psr\Http\Message\StreamFactoryInterface',
            'YardDeepl\Vendor_Prefixed\Psr\Http\Message\UploadedFileFactoryInterface',
            'YardDeepl\Vendor_Prefixed\Psr\Http\Message\UriFactoryInterface',
        ],
    ];
