...
use YardDeepl\Vendor_Prefixed\Http\Discovery\Exception\ClassInstantiationFailedException;
use YardDeepl\Vendor_Prefixed\Http\Discovery\Exception\DiscoveryFailedException;
use YardDeepl\Vendor_Prefixed\Http\Discovery\Exception\NoCandidateFoundException;
use YardDeepl\Vendor_Prefixed\Http\Discovery\Exception\StrategyUnavailableException;
use YardDeepl\Vendor_Prefixed\Http\Discovery\Strategy\DiscoveryStrategy;
