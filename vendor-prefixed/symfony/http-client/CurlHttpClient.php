...
use YardDeepl\Vendor_Prefixed\Symfony\Component\HttpClient\Internal\CurlClientState;
use YardDeepl\Vendor_Prefixed\Symfony\Component\HttpClient\Internal\PushedResponse;
use YardDeepl\Vendor_Prefixed\Symfony\Component\HttpClient\Response\CurlResponse;
...
final class CurlHttpClient implements HttpClientInterface, LoggerAwareInterface, ResetInterface
{
    ...
    public function __construct(array $defaultOptions = [], int $maxHostConnections = 6, int $maxPendingPushes = 0)
    {
        if (!\extension_loaded('curl')) {
            throw new \LogicException('You cannot use the "YardDeepl\Vendor_Prefixed\Symfony\Component\HttpClient\CurlHttpClient" as the "curl" extension is not installed.');
        }
