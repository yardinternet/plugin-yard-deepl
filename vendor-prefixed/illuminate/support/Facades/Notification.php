...
use YardDeepl\Vendor_Prefixed\Illuminate\Support\Testing\Fakes\NotificationFake;

/**
 * @method static \Illuminate\Notifications\ChannelManager locale(string|null $locale)
 * @method static \YardDeepl\Vendor_Prefixed\Illuminate\Support\Collection sent(mixed $notifiable, string $notification, callable $callback = null)
 ...
 * @method static void send(\YardDeepl\Vendor_Prefixed\Illuminate\Support\Collection|array|mixed $notifiables, $notification)
 * @method static void sendNow(\YardDeepl\Vendor_Prefixed\Illuminate\Support\Collection|array|mixed $notifiables, $notification)
 *
...
class Notification extends Facade
{
     ...
     *
     * @return \YardDeepl\Vendor_Prefixed\Illuminate\Support\Testing\Fakes\NotificationFake
     */
