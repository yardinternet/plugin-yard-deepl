...
/**
 * @method static \YardDeepl\Vendor_Prefixed\Symfony\Component\Finder\SplFileInfo[] allFiles(string $directory, bool $hidden = false)
 * @method static \YardDeepl\Vendor_Prefixed\Symfony\Component\Finder\SplFileInfo[] files(string $directory, bool $hidden = false)
 ...
 * @method static \YardDeepl\Vendor_Prefixed\Illuminate\Support\LazyCollection lines(string $path)
 * @method static void relativeLink(string $target, string $link)
 * @method static void replace(string $path, string $content)
 *
 * @see \YardDeepl\Vendor_Prefixed\Illuminate\Filesystem\Filesystem
 */
