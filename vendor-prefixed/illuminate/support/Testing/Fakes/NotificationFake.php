...
use Closure;
use Exception;
use YardDeepl\Vendor_Prefixed\Illuminate\Contracts\Notifications\Dispatcher as NotificationDispatcher;
use YardDeepl\Vendor_Prefixed\Illuminate\Contracts\Notifications\Factory as NotificationFactory;
use YardDeepl\Vendor_Prefixed\Illuminate\Contracts\Translation\HasLocalePreference;
...
class NotificationFake implements NotificationDispatcher, NotificationFactory
{
     ...
     *
     * @param  \YardDeepl\Vendor_Prefixed\Illuminate\Support\Collection|array|mixed  $notifiables
