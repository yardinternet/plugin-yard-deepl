...
use YardDeepl\Vendor_Prefixed\Illuminate\Contracts\View\Factory;
use YardDeepl\Vendor_Prefixed\Illuminate\Filesystem\Filesystem;
use YardDeepl\Vendor_Prefixed\Illuminate\Support\Str;
use YardDeepl\Vendor_Prefixed\Illuminate\View\AnonymousComponent;
use YardDeepl\Vendor_Prefixed\Illuminate\View\DynamicComponent;
use YardDeepl\Vendor_Prefixed\Illuminate\View\ViewFinderInterface;
...
class ComponentTagCompiler
{
     ...
     *
     * @var \YardDeepl\Vendor_Prefixed\Illuminate\View\Compilers\BladeCompiler
     */
    protected $blade;
     ...
     * @param  \YardDeepl\Vendor_Prefixed\Illuminate\View\Compilers\BladeCompiler|null  $blade
     * @return void
     */
        ...
        return collect($attributes)
                ->map(function (string $value, string $attribute) use ($escapeBound) {
                    return $escapeBound && isset($this->boundAttributes[$attribute]) && $value !== 'true' && ! is_numeric($value)
                                ? "'{$attribute}' => \YardDeepl\Vendor_Prefixed\Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute({$value})"
                                : "'{$attribute}' => {$value}";
                })
                ->implode(',');
    }
