...
use YardDeepl\Vendor_Prefixed\Illuminate\Contracts\View\Factory as ViewFactory;
use YardDeepl\Vendor_Prefixed\Illuminate\Contracts\View\View;
use YardDeepl\Vendor_Prefixed\Illuminate\Support\Arr;
use YardDeepl\Vendor_Prefixed\Illuminate\Support\Str;
use YardDeepl\Vendor_Prefixed\Illuminate\Support\Traits\ReflectsClosures;
use YardDeepl\Vendor_Prefixed\Illuminate\View\Component;
...
class BladeCompiler extends Compiler implements CompilerInterface
{
     ...
     *
     * @param  string  $contents
     * @return \YardDeepl\Vendor_Prefixed\Illuminate\Support\Collection
     */
     ...
     *
     * @param  \YardDeepl\Vendor_Prefixed\Illuminate\View\Component  $component
     * @return string
     */
    ...
    public function if($name, callable $callback)
    {
        ...
        $this->directive($name, function ($expression) use ($name) {
            return $expression !== ''
                    ? "<?php if (\YardDeepl\Vendor_Prefixed\Illuminate\Support\Facades\Blade::check('{$name}', {$expression})): ?>"
                    : "<?php if (\YardDeepl\Vendor_Prefixed\Illuminate\Support\Facades\Blade::check('{$name}')): ?>";
        });
        ...
        $this->directive('else'.$name, function ($expression) use ($name) {
            return $expression !== ''
                ? "<?php elseif (\YardDeepl\Vendor_Prefixed\Illuminate\Support\Facades\Blade::check('{$name}', {$expression})): ?>"
                : "<?php elseif (\YardDeepl\Vendor_Prefixed\Illuminate\Support\Facades\Blade::check('{$name}')): ?>";
        });
    ...
    public function aliasInclude($path, $alias = null)
    {
        ...
        $this->directive($alias, function ($expression) use ($path) {
            ...
            return "<?php echo \$__env->make('{$path}', {$expression}, \YardDeepl\Vendor_Prefixed\Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>";
        });
    }
