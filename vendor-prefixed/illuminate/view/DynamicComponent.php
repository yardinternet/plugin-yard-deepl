...
use YardDeepl\Vendor_Prefixed\Illuminate\View\Compilers\ComponentTagCompiler;
...
class DynamicComponent extends Component
{
     ...
     *
     * @var \YardDeepl\Vendor_Prefixed\Illuminate\View\Compilers\BladeTagCompiler
     */
     ...
     *
     * @return \YardDeepl\Vendor_Prefixed\Illuminate\Contracts\View\View|string
     */
    public function render()
    {
        $template = <<<'EOF'
<?php extract(collect($attributes->getAttributes())->mapWithKeys(function ($value, $key) { return [YardDeepl\Vendor_Prefixed\Illuminate\Support\Str::camel(str_replace([':', '.'], ' ', $key)) => $value]; })->all(), EXTR_SKIP); ?>
{{ props }}
...
EOF;
     ...
     *
     * @return \YardDeepl\Vendor_Prefixed\Illuminate\View\Compilers\ComponentTagCompiler
     */
