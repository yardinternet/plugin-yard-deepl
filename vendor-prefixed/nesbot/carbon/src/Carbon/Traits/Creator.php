...
use YardDeepl\Vendor_Prefixed\Carbon\Exceptions\InvalidDateException;
use YardDeepl\Vendor_Prefixed\Carbon\Exceptions\InvalidFormatException;
...
trait Creator
{
    ...
    public static function rawCreateFromFormat($format, $time, $tz = null)
    {
        ...
        /** @var \YardDeepl\Vendor_Prefixed\Carbon\CarbonImmutable|\YardDeepl\Vendor_Prefixed\Carbon\Carbon|null $mock */
     ...
     * @param \YardDeepl\Vendor_Prefixed\Symfony\Component\Translation\TranslatorInterface $translator optional custom translator to use for macro-formats
     *
     * @throws InvalidFormatException
     *
     * @return static|false
