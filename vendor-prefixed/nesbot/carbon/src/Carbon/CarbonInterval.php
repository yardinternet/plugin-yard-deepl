...
namespace YardDeepl\Vendor_Prefixed\Carbon;

use YardDeepl\Vendor_Prefixed\Carbon\Exceptions\BadFluentConstructorException;
use YardDeepl\Vendor_Prefixed\Carbon\Exceptions\BadFluentSetterException;
...
use YardDeepl\Vendor_Prefixed\Carbon\Exceptions\OutOfRangeException;
use YardDeepl\Vendor_Prefixed\Carbon\Exceptions\ParseErrorException;
use YardDeepl\Vendor_Prefixed\Carbon\Exceptions\UnitNotConfiguredException;
use YardDeepl\Vendor_Prefixed\Carbon\Exceptions\UnknownGetterException;
use YardDeepl\Vendor_Prefixed\Carbon\Exceptions\UnknownSetterException;
use YardDeepl\Vendor_Prefixed\Carbon\Exceptions\UnknownUnitException;
use YardDeepl\Vendor_Prefixed\Carbon\Traits\IntervalRounding;
use YardDeepl\Vendor_Prefixed\Carbon\Traits\IntervalStep;
use YardDeepl\Vendor_Prefixed\Carbon\Traits\MagicParameter;
use YardDeepl\Vendor_Prefixed\Carbon\Traits\Mixin;
use YardDeepl\Vendor_Prefixed\Carbon\Traits\Options;
use YardDeepl\Vendor_Prefixed\Carbon\Traits\ToStringFormat;
use Closure;
use DateInterval;
...
class CarbonInterval extends DateInterval implements CarbonConverterInterface
{
     ...
     *
     * @throws \YardDeepl\Vendor_Prefixed\Carbon\Exceptions\ParseErrorException when the $interval cannot be parsed as an interval.
     *
     * @return static
     */
    ...
    public function forHumans($syntax = null, $short = false, $parts = -1, $options = null)
    {
        ...
        /** @var \YardDeepl\Vendor_Prefixed\Symfony\Component\Translation\Translator $translator */
