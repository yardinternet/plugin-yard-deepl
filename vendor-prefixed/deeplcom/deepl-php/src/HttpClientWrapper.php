...
use YardDeepl\Vendor_Prefixed\Http\Discovery\Psr18Client;
use YardDeepl\Vendor_Prefixed\Http\Message\MultipartStream\MultipartStreamBuilder;
use YardDeepl\Vendor_Prefixed\Psr\Http\Client\ClientExceptionInterface;
